...
class dgs extends StatefulWidget {
  const dgs({Key? key, this.student, this.appTree}) : super(key: key);

  final student;
  final appTree;

  @override
  _dgsState createState() => _dgsState();
}
...
class _routeButtonState extends State<routeButton> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        _launched = _launch('https://www.turkiye.gov.tr/yok-universite-ekayit');
      },
      child: Container(
        height: 50,
        width: 325,
...
} // YABANCI DİL YETERLİLİK BELGESİ

class Page5 extends StatefulWidget {
  const Page5({Key? key, this.student, this.appTree}) : super(key: key);
...
class _Page5State extends State<Page5> {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Column(
        children: [
          fileUpload(input: "Sağlık Raporu",),
          ElevatedButton.icon(
            style: ElevatedButton.styleFrom(
...
} // SAĞLIK RAPORU BELGESİ

class _dgsState extends State<dgs> {
                    ...
                    child: Column(
                      ...
                      children: [
                        PForm(
                          ...
                          title: [
                            PTitle(
                              title: "E-DEVLET KAYIT İŞLEMLERİ",
                            ),
                            PTitle(
                              title: "TRANSKRİPT",
                            ),
                            ...
                            PTitle(title: "SAĞLIK RAPORU BELGESİ")
                          ],
                        )
                      ],
                    ),
